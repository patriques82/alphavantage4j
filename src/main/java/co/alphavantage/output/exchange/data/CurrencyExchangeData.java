...
public class CurrencyExchangeData {
	...
	public CurrencyExchangeData(String fromCurrencyCode, String fromCurrencyName, String toCurrencyCode,
			String toCurrencyName, float exchangeRate, LocalDateTime time, String timezone) {
